<div class="box box-info collapsed-box">
	<div class="box-header with-border">
		<p class="box-title">
			...
			{{ trans('bills_histories.histories') }}
		</p>
		...
		<table class="table table-condensed">
			<tr>
				...
				<th>
					...
					{{ trans('bills_histories.date') }}
				</th>

				<th>
					<i class="fa fa-toggle-on"></i>
					{{ trans('bills_histories.status') }}
				</th>

				<th>
					<i class="fa fa-file-o"></i>
					{{ trans('bills_histories.description') }}
				</th>
			</tr>
            <?php $i = 1; ?>
			@foreach($bill->bill_histories as $history)
				<tr>
					<td>
						{{ $i }}
                        <?php $i++; ?>
